const svg1 = (
    ...
    >
      <g filter="url(#filter0_f_6_129)">
        <path
          d="M290.452 193.57C286.565 226.486 256.872 262.119 227.63 278.23C198.389 294.342 142.906 306.65 115.003 290.24C87.0997 273.83 57.1879 216.641 60.2117 179.771C63.2355 142.901 101.355 85.5265 133.145 69.0206C164.936 52.5146 224.735 59.9765 250.953 80.7348C277.171 101.493 294.339 160.654 290.452 193.57C286.565 226.486 256.872 262.119 227.63 278.23Z"
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            stdDeviation="30"
            result="effect1_foregroundBlur_6_129"
          />
        </filter>
        <linearGradient
...
const svg2 = (
    ...
    >
      <g filter="url(#filter0_f_6_130)">
        <path
          d="M293.819 183.253C291.129 212.454 255.783 251.767 227.439 268.061C199.095 284.354 149.117 300.635 123.755 281.013C98.392 261.391 72.0738 183.886 75.2636 150.33C78.4535 116.774 114.841 89.26 142.894 79.6799C170.946 70.0999 218.424 75.5877 243.578 92.8498C268.733 110.112 296.509 154.051 293.819 183.253C291.129 212.454 255.783 251.767 227.439 268.061Z"
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            stdDeviation="37.5"
            result="effect1_foregroundBlur_6_130"
          />
        </filter>
        <linearGradient
          id="paint0_linear_6_130"
          x1="184.5"
          y1="75"
          x2="184.5"
          y2="290"
...
const svg3 =(
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <g filter="url(#filter0_f_6_125)">
        <path
          d="M303.632 179.251C307.347 208.754 282.331 255.394 255.502 275.913C228.672 296.431 172.71 313.795 142.655 302.363C112.599 290.93 77.7658 243.966 75.1672 207.318C72.5686 170.669 100.723 100.542 127.063 82.4723C153.404 64.4024 203.782 82.7682 233.21 98.898C262.638 115.028 299.917 149.749 303.632 179.251C307.347 208.754 282.331 255.394 255.502 275.913Z"
          fill="url(#paint0_linear_6_125)"
        />
      </g>
      <defs>
        <filter
        ...
        >
          ...
          <feGaussianBlur
            stdDeviation="37.5"
            result="effect1_foregroundBlur_6_125"
          />
        </filter>
        <linearGradient
